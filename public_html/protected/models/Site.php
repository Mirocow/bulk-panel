...
class Site extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('email, title, contacts, invoice_details, head_name, e_wallets, yandex_money, robokassa', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, url, created, domain, email, title, contacts, invoice_details, head_name, e_wallets, yandex_money, robokassa, style_id, reseller_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('robokassa',$this->robokassa,true);
    ...
    public function getPaymentMethods()
    {
        ...
        {
            $methods[] = ['name' => 'Яндекс.Деньги', 'img' => '', 'code' => 'YANDEXMONEY'];
        }
        if($this->robokassa != '')
        {
