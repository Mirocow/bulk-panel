...
class Style extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, reseller_id', 'required'),
			array('reseller_id', 'numerical', 'integerOnly'=>true),
			array('content', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, content, reseller_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'sites' => array(self::HAS_MANY, 'Site', 'style_id'),
